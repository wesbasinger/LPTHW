# In this exercise, we will do practice with only the
# print statement.  Just read the commented lines and
# put a print statement to print exactly what is in the
# single quotes.
...
# Please, this is supposed to be a happy occasion. Let us not bicker and argue over who killed who.
